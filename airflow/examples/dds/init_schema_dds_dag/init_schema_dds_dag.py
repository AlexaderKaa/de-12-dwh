...
@dag(
    ...
    tags=['sprint5', 'dds', 'schema', 'init', 'ddl', 'example'],  # Теги, используются для фильтрации в интерфейсе Airflow.
...
dds_init_schema_dag = dds_init_schema_dag()  # noqa
