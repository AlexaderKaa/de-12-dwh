...
from examples.dds.dds_dm_deliveries_fill_dag.dds_delivery_loader import DDSDeliveryLoader
...
def dds_dm_deliveries_fill_dag():
    ...
    def dds_load_deliveries():
        ...
        # Загружаем данные
        dds_delivery_loader.load_deliveries()

    # Инициализируем таск
    deliveries_dict = dds_load_deliveries()
    deliveries_dict  # type: ignore


# Инициализируем DAG
dds_dm_deliveries_fill_dag = dds_dm_deliveries_fill_dag()