...
@dag(
    ...
    tags=['sprint5', 'cdm', 'schema', 'ddl', 'example'],  # Теги, используются для фильтрации в интерфейсе Airflow.
...
cdm_init_schema_dag = cdm_init_schema_dag()  # noqa
